#ifndef _INCLUDE_DEBUGOVERLAY_H
#define _INCLUDE_DEBUGOVERLAY_H
...
public:
	...
	virtual void AddCoordFrameOverlay(const matrix3x4_t& frame, float flScale, int ppColorTable[3][3] = NULL) = 0;
